...
tableconfcurrent.head = columnfilter.concat(['status', 'up-time']).map(function (obj) {
    return colors.yellow(obj);
});
var tableconfhistory = Object.assign({}, tableconf);
tableconfhistory.head = columnfilter.concat(['status', 'start/stop time']).map(function (obj) {
    return colors.yellow(obj);
});
